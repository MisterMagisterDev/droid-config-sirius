# DisplayName: Jolla sirius/@ARCH@ (release) 1
...
repo --name=adaptation0-sirius-@RELEASE@ --baseurl=https://store-repository.jolla.com/releases/@RELEASE@/jolla-hw/adaptation-sony-sirius/@ARCH@/
...
%packages
@Jolla Configuration sirius
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/sirius
